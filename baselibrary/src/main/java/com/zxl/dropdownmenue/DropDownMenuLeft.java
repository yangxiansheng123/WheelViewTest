...
//    private int dividerColor = 0xffcccccc;
    ...
    public DropDownMenuLeft(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DropDownMenuLeft(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static final int TEACHER_FILTER = 5;
